...
def parse_args():
    ...
    parser.add_argument('--save_dir', default="/home/codee/scratch/sourcecode/cem-dataset/benchdata", type=str, metavar='save_dir', help='Directory in which to save the benchmark datasets')
...
if __name__ == '__main__':
    ...
    #save_dir = "/home/codee/scratch/sourcecode/cem-dataset/benchdata"
    ...
    for ip, mp in zip(guay_impaths, guay_mskpaths):
        ...
        command = f'/home/codee/miniconda3/bin/python {create_slices_script} {ip} {mp} {slice_dir} -a 2 -s 1'
        subprocess.call(command.split(' '))
    ...
    for ip, mp in zip(urocell_impaths, urocell_mskpaths):
        ...
        command = f'/home/codee/miniconda3/bin/python {create_slices_script} {ip} {mp} {slice_dir} -a 0 1 2 -s 1'
        subprocess.call(command.split(' '))
    ...
    for l, bmk in zip(benchmark_mito_labels, benchmarks):
        command = f'/home/codee/miniconda3/bin/python {create_patches_script} {save_dir}/{bmk}/train/images/ {save_dir}/all_mito/train/images/'
        subprocess.call(command.split(' '))
        
        command = f'/home/codee/miniconda3/bin/python {create_patches_script} {save_dir}/{bmk}/train/masks/ {save_dir}/all_mito/train/masks/ -l {l}'
        subprocess.call(command.split(' '))
